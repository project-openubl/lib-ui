...
const deleteApplication = (id: number) => {
  return axios.delete(`${APPLICATIONS_URL}/${id}`);
};
...
describe('useDelete', () => {
  ...
  it('Delete error', async () => {
    ...
    // Mock REST API
    new MockAdapter(axios).onDelete(`${APPLICATIONS_URL}/${app.id}`).networkError();
  ...
  it('Delete success', async () => {
    ...
    // Mock REST API
    new MockAdapter(axios).onDelete(`${APPLICATIONS_URL}/${version.id}`).reply(201);
